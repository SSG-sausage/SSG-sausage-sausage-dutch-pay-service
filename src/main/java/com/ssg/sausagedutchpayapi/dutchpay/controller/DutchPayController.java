...
public class DutchPayController {
    ...
    @Operation(summary = "정산 생성", responses = {@ApiResponse(responseCode = "201", description = "정산 생성 성공입니다."),
            @ApiResponse(responseCode = "409", description = "해당 주문에 대한 정산 데이터가 이미 존재합니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
    ...
    public ResponseEntity<SuccessResponse<String>> saveDutchPay(@RequestBody DutchPaySaveRequest request) {
    ...
    @Operation(summary = "정산 금액 계산", responses = {@ApiResponse(responseCode = "200", description = "정산 조회 성공입니다."),
