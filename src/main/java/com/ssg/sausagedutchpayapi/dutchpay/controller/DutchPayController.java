...
public class DutchPayController {
    ...
    @Operation(summary = "함께쓱정산 생성", responses = {
            ...
            @ApiResponse(responseCode = "400", description = "해당 주문에 대한 함께쓱정산 데이터가 이미 존재합니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
    ...
    public ResponseEntity<SuccessResponse<DutchPaySaveResponse>> saveDutchPay(
