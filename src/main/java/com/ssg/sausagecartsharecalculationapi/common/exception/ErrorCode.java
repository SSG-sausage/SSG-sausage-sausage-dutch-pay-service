package com.ssg.sausagecartsharecalculationapi.common.exception;

import static com.ssg.sausagecartsharecalculationapi.common.exception.ErrorStatusCode.BAD_GATEWAY;
import static com.ssg.sausagecartsharecalculationapi.common.exception.ErrorStatusCode.BAD_REQUEST;
import static com.ssg.sausagecartsharecalculationapi.common.exception.ErrorStatusCode.CONFLICT;
import static com.ssg.sausagecartsharecalculationapi.common.exception.ErrorStatusCode.FORBIDDEN;
import static com.ssg.sausagecartsharecalculationapi.common.exception.ErrorStatusCode.INTERNAL_SERVER;
import static com.ssg.sausagecartsharecalculationapi.common.exception.ErrorStatusCode.NOT_FOUND;
import static com.ssg.sausagecartsharecalculationapi.common.exception.ErrorStatusCode.SERVICE_UNAVAILABLE;
import static com.ssg.sausagecartsharecalculationapi.common.exception.ErrorStatusCode.UNAUTHORIZED;
